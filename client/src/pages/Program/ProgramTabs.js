    ...
    <div className="grid grid-cols-3 space-x-12">
      ...
      <div className="flex-1 break-words rounded-2xl col-span-2 border-red-400">
        <div
          className={
            activeTab === 1
              ? "block px-10 py-10 rounded-xl relative text-white multiGradient animate-animateGradient"
              : "hidden"
          }
        >
          <div className="before absolute top-0 left-0 w-full h-full rounded-xl -z-1 filter blur-2xl multiGradient animate-animateGradient"></div>
          <h1 className="text-center text-3xl">WE WILL TEACH YOU: </h1>
          <p className="text-lg p-6 leading-loose">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse
            posuere quam a tortor iaculis, ac tempus enim sollicitudin. Nunc a
            nisl ac urna maximus vehicula vel vel turpis. Curabitur tempus
            lectus at euismod iaculis. Pellentesque et ultrices urna. In sit
            amet urna pretium, scelerisque velit sit amet, mollis nibh. Duis
            turpis lorem, elementum et metus vel, fringilla dignissim neque.
            Maecenas malesuada volutpat efficitur. Nulla ornare pellentesque
            ornare. Vivamus non elementum tellus. Pellentesque vulputate metus
            neque, at maximus sapien auctor at. Nulla ipsum dui, feugiat sed
            ipsum nec, fringilla aliquet magna. Duis malesuada, ligula id luctus
            congue, arcu lectus ornare turpis, id venenatis lacus lorem vitae
            magna. Duis vestibulum m
          </p>
        </div>
        <div
          className={
            activeTab === 2
              ? "block px-10 py-10 rounded-xl relative text-white blueGradient animate-animateGradient"
              : "hidden"
          }
        >
          <div className="before absolute top-0 left-0 w-full h-full rounded-xl -z-1 filter blur-2xl blueGradient animate-animateGradient"></div>
        ...
        <div
          className={
            activeTab === 3
              ? "block px-10 py-10 rounded-xl relative text-white greenGradient animate-animateGradient"
              : "hidden"
          }
        >
          <div className="before absolute top-0 left-0 w-full h-full rounded-xl -z-1 filter blur-2xl greenGradient animate-animateGradient"></div>
          <h1 className="text-center text-3xl">
            WE WILL GET YOU PREPARED FOR A NEW CAREER:{" "}
          </h1>
          <p className="text-lg p-6 leading-loose">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse
            posuere quam a tortor iaculis, ac tempus enim sollicitudin. Nunc a
