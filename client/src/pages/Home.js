...
const Home = () => {
  return (
    <div>
      <header className="bg-gradient-to-r from-purple-400 via-green-400 to-red-400 h-1/2">
        <div className="flex-col justify-items-center mx-auto px-2 w-3/4 space-y-2 ">
