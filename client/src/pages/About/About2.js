...
export default function About2() {
    return (
        <div className="pb-16 pt-24 bg-gray-800 overflow-hidden lg:pb-24 lg:pt-28">
            <div className="relative max-w-xl mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-7xl">
                ...
                <div className="relative animate-fadeIn">
                    <h2 className="text-center text-3xl xl:text-4xl leading-8 font-extrabold tracking-tight text-gray-50 sm:text-4xl">
                        Our Mission
                    </h2>
                    <p className="mt-4 max-w-3xl mx-auto text-center text-2xl xl:text-2xl text-gray-400">
                ...
                <div className="relative mt-12 lg:mt-24 lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
                    <div className="relative animate-fadeIn xl:animate-fadeFromLeft">
                                ...
                                <div key={item.id} className="relative">
                                    <dt>
                                        <div className="absolute flex items-center justify-center h-12 w-12 rounded-md multiGradient animate-animateGradient text-white">
                                            <item.icon className="h-6 w-6 text-gray-50" aria-hidden="true" />
                                        </div>
                    ...
                    <div className="mt-10 -mx-4 relative lg:mt-0" aria-hidden="true">
                        ...
                        <img
                            className="relative mx-auto animate-fadeIn"
                            width={490}
                    ...
                    >
                        <div className="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:gap-8 lg:items-center">
                            <div className="lg:col-start-2">
                                <h3 className="text-2xl font-extrabold text-gray-50 tracking-tight sm:text-3xl">Let's Build a Community</h3>
