...
function Callout(props) {
  ...
  return (
    <>
      ...
      <Link
        to={props.to}
        className="transition duration-150 ease-in-out transform hover:scale-105 flex justify-start text-xl rounded bg-gradient-to-r from-purple-500 to-red-600 text-black p-2 mt-5"
